...
public class CompanyService {
    ...
    public Page<CompanyDTO> searchCompanies(String keyword, Pageable pageable) {
        return companyRepository.findCompanies(keyword, pageable);
    }
    ...
    public Optional<CompanyDetailDTO> getCompanyDetailById(int id) {
        return companyRepository.findCompanyDetailById(id);
    }
}
