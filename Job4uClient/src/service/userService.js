...
const getAllUsers = (data) => {
  return axios.get(
    `/api/get-all-user?limit=${data.limit}&offset=${data.offset}`
  );
};
...
const getListAllCodeService = (data) => {
  return axios.get(
    `/api/get-list-allcode?type=${data.type}&limit=${data.limit}&offset=${data.offset}`
  );
};
...
const getAllUserByCompanyIdService = (data) => {
  return axios.get(
    `/api/get-all-user-by-company_id?companyId=${data.companyId}&limit=${data.limit}&offset=${data.offset}`
  );
};
...
const getListCompany = (data) => {
  return axios.get(
    `/api/get-list-company?limit=${data.limit}&offset=${data.offset}`
  );
};
//======================== POST ====================================//
...
const getAllPostByAdminService = (data) => {
  return axios.get(
    `/api/get-list-post-admin?companyId=${data.companyId}&limit=${data.limit}&offset=${data.offset}`
  );
};
